...
var gridLines = {
  '&::before': tslib.__assign(tslib.__assign({}, cropperLines), {
    top: 0,
    bottom: 0,
    left: '33.33%',
    right: '33.33%',
  ...
  '&::after': tslib.__assign(tslib.__assign({}, cropperLines), {
    top: '33.33%',
    bottom: '33.33%',
    left: 0,
    right: 0,
...
var CropArea = styled('div')({}, function (_a) {
  ...
  return tslib.__assign(tslib.__assign({}, function () {
    switch (cropShape) {
      case 'round':
        return tslib.__assign(tslib.__assign({}, cropperArea), roundShape);
